...
public class test {
	public static void main(String[] args) {  
	    String content = "0E6EF81FD66BDFEE048E2C3F9A880099";
	        ...
	        // 解密  
	            ...
	            String s1 = decrypt(content, password);  
	            System.out.println("解密后：" +s1);  
	          
	    }  
	public static String encrypt1(String bef_aes) {
		String content = bef_aes;
	    String password = "12345678";  
	    String s = encrypt(content, password);  
		return s;
		
	}
	public static String decrypt1(String bef_aes) {
		String content = bef_aes;
	    String password = "12345678";  
